...
Top 40 Frequent Words in True News: 

  
 

Top 40 Frequent Words in Fake News: 
  
 
Display the top 10 unigrams by frequency in true news and plot them as a bar graph 
  
 
 Display the top 10 bigrams by frequency in true news and plot them as a bar graph  
 
  
 
 Display the top 10 trigrams by frequency in true news and plot them as a bar graph 
  
 
Display the top 10 unigrams by frequency in fake news and plot them as a bar graph 
 
  
 
Display the top 10 bigrams by frequency in fake news and plot them as a bar graph 
  
 
 Display the top 10 trigrams by frequency in fake news and plot them as a bar graph 
...
•	True news articles contained more formal government-related words like "government", 
"state", "official". 
...
![image](https://github.com/user-attachments/assets/8c637f4b-97d1-4ec3-8bd4-89a9910215e6)
